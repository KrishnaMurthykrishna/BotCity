...
from opensource_crud_examples import main as http_api_main  # noqa: E402
...
def main():
    ...
    maestro.alert(task_id=execution.task_id, title="Example Bot finished!", message="The bot has finished its execution.", alert_type=AlertType.INFO)
